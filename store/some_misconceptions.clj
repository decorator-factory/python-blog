($
  ...
  (horizontal-rule)
  (p
    "Some resources get it wrong even worse. For example, "
  ...
  (p
    (mono "str.isdigit") " might seem an obvious choice, but there's
  ...
  (p
    "Those operators help determine ordering: whether one element
